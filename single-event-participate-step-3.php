            ...
            <form method="post" accept-charset="UTF-8">
              ...
              <div class="check-0 d-none">
                <div class="row mx-auto">
                  <a href="<?=get_the_permalink()?>?participate=step-4&single=true" class="btn btn-lg btn-secondary btn-block px-5"><?=__('参赛', 'young-bird')?></a>
                </div>
              </div>
              <div class="check-1 d-none">
                ...
                <div class="form-group team">
                  <div class="input-group input-group-lg">
                    <input type="text" name="group_name_create" class="form-control" placeholder="<?=__('团队名称', 'young-bird')?>">
                    <div class="input-group-append">
                      <button type="submit" name="create_group" class="btn btn-secondary px-5"><?=__('创建', 'young-bird')?></button>
                    </div>
                  </div>
                </div>
                <div class="form-group team d-none">
                  <div class="input-group input-group-lg">
                    <input type="text" name="group_name_join" class="form-control" placeholder="<?=__('团队名称', 'young-bird')?>">
                    <div class="input-group-append">
                      <button type="submit" name="join_group" class="btn btn-secondary px-5"><?=__('加入', 'young-bird')?></button>
                    </div>
                  </div>
                </div>
              </div>
