      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-12">
          <div class="msg text-center">
            ...
            <h3 class="mt-3"><?=__('成功激活大咖账号', 'young-bird')?>！</h3>
            <!--<p class="mb-2"><?=__('您即将进入评委中心，如果未自动跳转，请点击以下链接', 'young-bird')?></p>-->
            <a href="<?=site_url()?>/judge-center/"><u><?=__('进入大咖中心', 'young-bird')?></u></a>
          </div>
          ...
          <a href="<?=site_url()?>" class="btn btn-secondary btn-block btn-lg"><?=__('进入网站首页', 'young-bird')?></a>
        </div>
      </div>
    </div>
