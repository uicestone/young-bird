...
add_action('wp', function() {
  ...
  // wp_register_script('swiper_center', get_stylesheet_directory_uri() . '/js/swiper.js', array('jquery'), false, true);
  ...
  wp_register_script('add_main', get_stylesheet_directory_uri() . '/js/add_main.js', array(), '1.0.0'.time(), true);
...
add_action('wp_enqueue_scripts', function(){
  ...
  // wp_enqueue_script('swiper_center');
